...
export class CrmController {
  ...
  @ApiResponse({ status: 200, description: 'Contacts retrieved successfully', type: [CrmContact] })
  ...
  @ApiResponse({ status: 200, description: 'Contact retrieved successfully', type: CrmContact })
  ...
  @ApiResponse({ status: 201, description: 'Contact created successfully', type: CrmContact })
  @Roles(UserRole.AGENT, UserRole.ADMIN, UserRole.LANDLORD)
